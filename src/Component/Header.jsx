...
const Header = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const categoryResponse = await axios.get("http://3.23.76.252:8080/api/category/false/true");
        setCategories(categoryResponse.data);
        const subCategoryResponse = await axios.get("http://3.23.76.252:8080/api/subCategory/true");
          ...
          <div className="bg-light py-1">
            <div className="container">
              ...
              <div className="col-md-10 col-12 d-flex " style={{ alignItems: 'center' }}>
                  ...
                  <span>User ID: {userId ? userId : "Not Logged In"}</span>
                </div>
                <div className="col-md-2 col-xxl-1 text-end d-none d-lg-block" style={{ marginLeft: '20px' }}>
                  <div className="list-inline">
                    ...
                    <div className="list-inline-item">
                    <Link
  to="/ShopCart"   // Ensure this path matches the route for your cart page
  className="text-muted position-relative"
  role="button"
>
      ...
      <div className="col-12 col-md-6 col-lg-9 py-2">
  ...
  <div className="dropdown-menu sm-menu" aria-labelledby="adminDropdown">
    <Link className="dropdown-item" to="/AdminCategoryList">
      Category
    </Link>
    <Link className="dropdown-item" to="/AdminSubCategoryList">
      Sub Category
    </Link>
    <Link className="dropdown-item" to="/AdminProductList">
      Product
    </Link>
    <Link className="dropdown-item" to="/AdminCityList">
      City
    </Link>
  </div>
</li>
...
<div className="dropdown-menu megamenu sm-menu border-top" aria-labelledby="dropdown01">
  <div className="row">
    {categories.map((category) => {
      ...
      return (
        <div className="col-sm-6 col-lg-3 border-right mb-4" key={category.id}>
          <div className="ps-3">
            {/* Category Name Aligned Left */}
            <h6 className="text-primary">{category.name}</h6>
            {/* Subcategories Below the Category */}
            <ul className="list-unstyled ms-2">
              {categorySubCategories.length > 0 ? (
                categorySubCategories.map((sub) => (
                  <li key={sub.subCategoryId}>
                    <Link 
                      ...
                      onClick={() => console.log("Navigating to Shop with subCategoryId:", sub.subCategoryId)}
                    >
                      {sub.subCategoryName}
                    </Link>
                  </li>
                ...
                <li>
                  <Link className="dropdown-item" to="/Shop">Others</Link>
                </li>
              )}
            </ul>
          </div>
